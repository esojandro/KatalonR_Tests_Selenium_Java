...
public class Test5IntentoSumarLetra {
  ...
  @Test
  public void test5IntentoSumarLetra() throws Exception {
    driver.get("https://testsheepnz.github.io/BasicCalculator.html");
    driver.findElement(By.id("number1Field")).click();
    driver.findElement(By.id("number1Field")).clear();
    driver.findElement(By.id("number1Field")).sendKeys("12x45");
    driver.findElement(By.id("number2Field")).click();
    driver.findElement(By.id("number2Field")).clear();
    driver.findElement(By.id("number2Field")).sendKeys("4568789456");
    driver.findElement(By.id("selectOperationDropdown")).click();
    new Select(driver.findElement(By.id("selectOperationDropdown"))).selectByVisibleText("Multiply");
