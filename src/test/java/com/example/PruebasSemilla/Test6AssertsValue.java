...
public class Test6AssertsValue {
  ...
  @Test
  public void test6AssertsValue() throws Exception {
    ...
    assertEquals("5", driver.findElement(By.id("number1Field")).getAttribute("value"));
    ...
    assertEquals("15", driver.findElement(By.id("number2Field")).getAttribute("value"));
